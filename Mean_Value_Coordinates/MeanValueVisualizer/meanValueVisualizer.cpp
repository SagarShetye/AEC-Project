...
void meanValueVis::colourAllPolygons(PolygonalMesh mesh, YsColor colour) {
	for (auto plgHd = mesh.NullPolygon(); mesh.MoveToNextPolygon(plgHd) == true;) {
		mesh.SetPolygonColor(plgHd,colour);
	}
}
